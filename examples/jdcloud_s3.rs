...
async fn main() -> Result<(), aws_sdk_s3::Error> {
    ...
    let c = Credentials::new("4107B314B15BCE99A1C781DFCF119F59",
                             "8877CD432EB5738EFF0FA01F630201C9",
                             None, None, "Static");

    let shared_config = aws_config::from_env().credentials_provider(c).region(Region::new("cn-north-1")).load().await;
    ...
    let obj_list = client.list_objects()
        .bucket("pingdata")
    ...
    let resp = client.get_object().bucket("tsp-picture")
        .key("tsp-picture/46b6d4e6-1446-4da2-a10b-91fd3d73cebb.jpg").send().await?;
